            ...
            <div className="relative my-[157px] mx-[90px]">
                ...
                <div className='relative mt-[80px] w-full flex justify-between'>
                    <div className='w-auto h-auto max-w-[66%] flex flex-col justify-start'>
                        ...
                        <div className='mt-[16px] w-full self-stretch text-white font-inter text-[24px] font-normal leading-[35.04px]'>
                ...
                <div className='relative mt-[128px] flex flex-col'>
                    ...
                    <div className='mt-[48px] w-full flex justify-center items-center'>
                        <div className="w-[1575px] h-[883px] bg-zinc-800 rounded-[30px] flex flex-col justify-start items-center">
                            ...
                            <div className='px-[320px] w-full h-[98px] bg-[rgba(255,255,255,0.10)] flex justify-between items-center'>
                            ...
                            <div className='w-full h-[98px] px-[320px] flex justify-center items-center'>
                                <div className="w-full h-[43px] bg-white rounded border border-neutral-200 flex justify-between items-center">
                                    <div className="text-neutral-800 text-base font-normal font-roboto ml-5">Thank you!</div>
                                    <div className="w-[54px] h-[41px] bg-zinc-100 rounded-[3px] flex justify-center items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
