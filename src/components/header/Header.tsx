            ...
            {/* {window.innerWidth > 768 ? ( */}
                <div className="w-full h-[104px] flex items-center border-b border-[#F4F4F4] bg-white bg-opacity-60 flex-shrink-0 z-50">
                    <div className="mx-[90px] mt-[24px] mb-[22px] flex items-center z-20">
                        <div className="w-[282px] h-[58px] flex items-center cursor-pointer"  onClick={() => router.push('/home')}>
                            ...
                            <span className="ml-[17px] text-[#111] font-roboto text-3xl font-medium leading-normal">
                                NetMind XYZ
                            </span>
                        </div>
